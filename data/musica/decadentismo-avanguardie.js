  ...
  questions: [
    ...
    // === ESPRESSIONISMO E ATONALITÀ (9 domande) ===
    {
      ...
      options: [
        ...
        "Paesi di lingua tedesca e Nord Europa",
        "Spagna e Portogallo",
    ...
    {
      q: "Che cosa vuole esprimere l'Espressionismo?",
      options: [
        "La gioia e la serenità della vita di campagna",
        "Il fascino per le culture esotiche",
    ...
    {
      q: "Chi è il principale musicista dell'Espressionismo?",
      options: [
        "Igor Stravinskij",
        "Béla Bartók",
        "Arnold Schönberg",
    ...
    {
      q: "A quale teoria si ispira Schönberg per la sua musica?",
      options: [
        "Alla filosofia di Nietzsche",
        "Alla psicanalisi di Freud",
    ...
    {
      q: "Quale di queste caratteristiche NON appartiene alla musica atonale?",
      options: [
        "Assenza di scale tradizionali",
        "Suoni che sembrano instabili",
    ...
    {
      q: "Quali emozioni esprime la musica atonale di Schönberg?",
      options: [
        "Allegria e serenità",
    ...
    {
      q: "Quali sezioni dell'orchestra hanno un ruolo importante in Vorgefühle?",
      options: [
        "Solo gli archi",
        "Voci bianche e arpa",
    ...
    {
      q: "Il brano Vorgefühle è tratto da:",
      options: [
    ...
    {
      q: "Quando Schönberg inventa la dodecafonia?",
      options: [
    ...
    {
      q: "Su quanti suoni si basa la dodecafonia, e che caratteristica hanno?",
      options: [
        "7 suoni, uno principale e gli altri secondari",
        "8 suoni, organizzati in scala maggiore",
    ...
    // === FOLKLORE ED ESOTISMO (15 domande) ===
    {
      ...
      options: [
        "Musica popolare, tradizioni locali e culture lontane",
        "Solo la musica classica europea",
    ...
    {
      q: "Come si chiama lo studio delle musiche etniche e popolari?",
      options: [
        "Antropologia",
        "Etnomusicologia",
        "Musicografia",
    ...
    {
      q: "Da quale scrittore nasce il Verismo letterario?",
      options: [
        "Gabriele D'Annunzio",
        "Giosuè Carducci",
        "Giovanni Verga",
    ...
    {
      q: "Quale di queste NON è una caratteristica del Verismo?",
      options: [
        "Racconta la vita delle persone povere",
    ...
    {
      q: "L'opera più famosa di Pietro Mascagni è:",
      options: [
        "Turandot",
        "Pulcinella",
    ...
    {
      q: "Dove è ambientata Cavalleria rusticana?",
      options: [
        "In Sicilia",
        "In Cina",
        "In Spagna",
    ...
    {
      q: "Il brano \"O Lola\" è caratterizzato da:",
      options: [
        "Stile della siciliana, andamento lento, modo minore",
        "Ritmi vivaci e melodie pentatoniche",
    ...
    {
      q: "Quale folklore musicale studia Béla Bartók?",
      options: [
        "Spagnolo e gitano",
        "Ungherese e balcanico",
        "Cinese e orientale",
    ...
    {
      q: "Le \"Danze popolari rumene\" di Bartók presentano:",
      options: [
        "Dodecafonia e atonalità",
        "Melodie pentatoniche e celesta",
    ...
    {
      q: "Manuel de Falla nella sua musica unisce:",
      options: [
        "Musica barocca e dodecafonia",
        "Musica orientale e verismo italiano",
    ...
    {
      q: "Quali elementi caratterizzano la musica di De Falla?",
      options: [
        "Ritmi lenti, archi e melodie tedesche",
        "Ritmi vivaci, percussioni e melodie gitane",
    ...
    {
      q: "La \"Danza ritual del fuego\" di De Falla è caratterizzata da:",
      options: [
        "Andamento lento in modo minore",
        "Trilli ripetuti e crescendo continui",
    ...
    {
      q: "A quale cultura si ispira Puccini nella Turandot?",
      options: [
        "All'Oriente e alla musica cinese",
        "Al folklore spagnolo",
    ...
    {
      q: "Dove è ambientata la Turandot di Puccini?",
      options: [
        "Sicilia rurale dell'Ottocento",
        "Spagna gitana",
    ...
    {
      q: "Quali strumenti accompagnano il brano \"Là sui monti dell'Est\" della Turandot?",
      options: [
        "Ottoni e percussioni potenti",
        "Solo archi e fiati",
    ...
    {
      q: "In \"Nessun dorma\" della Turandot, chi canta e con quale voce?",
      options: [
        "Calaf, tenore",
        "Turandot, soprano",
        "Liù, mezzosoprano",
    ...
    // === NEOCLASSICISMO (6 domande) ===
    {
      ...
      options: [
        "Medioevo e Classicismo viennese",
    ...
    {
      q: "Chi è il principale autore del Neoclassicismo musicale?",
      options: [
        "Arnold Schönberg",
        "Giacomo Puccini",
        "Pietro Mascagni",
    ...
    {
      q: "Quale di queste opere NON è di Stravinskij?",
      options: [
        "Petruska",
        "La sagra della primavera",
        "Cavalleria rusticana",
    ...
    {
      q: "Il brano \"Pulcinella\" di Stravinskij è caratterizzato da:",
      options: [
        "Dissonanze estreme e atonalità",
        "Ritmo moderato, stile gioioso e richiami al barocco",
    ...
    {
      q: "Perché durante la Prima guerra mondiale cambia il modo di fare musica?",
      options: [
        "Tutti i musicisti vanno al fronte",
        "Il pubblico preferisce ascoltare la radio",
    ...
    {
      q: "Nell'Histoire du soldat di Stravinskij, cosa simboleggia il soldato?",
      options: [
        "L'anima",
        "Il destino malvagio",
    ...
    {
      q: "Nell'Histoire du soldat di Stravinskij, cosa simboleggia il violino?",
      options: [
        "Il destino malvagio",
        "L'anima",
        "L'umanità sofferente",
    ...
    {
      q: "Nell'Histoire du soldat di Stravinskij, cosa simboleggia il diavolo?",
      options: [
        "L'umanità sofferente",
        "L'anima",
        "Il destino malvagio",
    ...
    {
      q: "Come termina la \"Marcia trionfale del diavolo\" nell'Histoire du soldat?",
      options: [
        "Con un crescendo fortissimo di tutta l'orchestra",
